    ...
    return (
      <div>
        ...
        <p className='md:text-xl'>
          Unable to load about page content from Sanity.
        </p>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <main>
        ...
        {listenAppPartners && (
          <LogoSection
            colourScheme={listenAppPartners.colourScheme}
            title={listenAppPartnersTitle || 'ListenApp Partners'}
            logos={listenAppPartners.logos}
          />
        )}
        ...
        {specialThanks && (
          <LogoSection
            colourScheme={specialThanks.colourScheme}
