...
export default function QuickExit() {
  ...
  return (
    <a
      ...
      className='fixed bottom-4 right-4 z-[60] inline-flex items-center gap-2 px-5 py-3 rounded-full bg-mf-coral text-white text-sm md:text-base font-grotesk-medium whitespace-nowrap shadow-lg hover:brightness-110 transition-all focus:outline-none focus:ring-2 focus:ring-white/80'
    >
      <svg
        width='16'
        height='16'
